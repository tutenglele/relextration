...
class Params:
    ...
    def __init__(self, ex_index=1, corpus_type='NYT'):
        ...
        self.downs_en_lr = (3e-5)*5 # (4e-5)*4  4e-4 _NYT89.8(cls直接linear，后pooling)  (4e-5)*4web0.751  改完rel0.781  改drop为0.5 0.75  3e-5*5&改r from so0.808  r提取用bertoutput效果一般0.70，
        self.clip_grad = 2.
